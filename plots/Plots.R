...
# 
# # HR vs signature activity
# 
# SBS4_survival_continuous_external <- plot_signature_survival_continuous(biological_weights_external, survival_data_external, "external", "SBS4") 
# 
# 
# # plot_signature_survival_continuous(rbind(biological_weights_paper,biological_weights_external), rbind(survival_data_paper,survival_data_external), "all", "SBS4")
# 
# SBS13_survival_continuous_external <- plot_signature_survival_continuous(biological_weights_external, survival_data_external, "external", "SBS13")
# plot_signature_survival_continuous(rbind(biological_weights_paper,biological_weights_external), rbind(survival_data_paper,survival_data_external), "all", "SBS13")
# 
# sig_result_SBS13_all <- analyze_signature(signature_name = "SBS13", dataset = "all", biological_weight_table = rbind(biological_weights_paper, biological_weights_external),survival_data = rbind(survival_data_paper, survival_data_external) )
# 
# sig_result_SBS4_all <- analyze_signature(signature_name = "SBS4", dataset = "all", biological_weight_table = rbind(biological_weights_paper, biological_weights_external),survival_data = rbind(survival_data_paper, survival_data_external) )

##--------------- ANALYSIS FOR CESA_PAPER (paper data)-------
# Plot box plot of log(TMB) vs mutations attributed to SBS4 and SBS13
data_paper <- biological_weights_paper[, .(total_snvs, TMB_per_Mb, SBS3, SBS4, SBS5, SBS13, SBS24, SBS31, SBS87)]
...
paper_signatures_merged <- merge(paper_signatures, biological_weights_paper[, .(Unique_Patient_Identifier, total_snvs, TMB_per_Mb)], by = "Unique_Patient_Identifier")
data_paper_sig <- paper_signatures_merged[, .(total_snvs, TMB_per_Mb, SBS4, SBS5, SBS13)]
...
SBS4_survival_0.25 <- SBS4_results$all$plot_0.25
# SBS4_survival_optimal <- SBS4_results$paper$binary$plot_optimal
# SBS4_survival_continuous <- plot_signature_survival_continuous(biological_weights_paper, survival_data_paper, "paper", "SBS4")

SBS13_survival_0.25 <- SBS13_results$all$plot_0.25
# SBS13_survival_0.25 <- SBS13_survival_0.25$plot_0.25
# SBS13_survival_optimal <- SBS13_results$paper$binary$plot_optimal
# SBS13_survival_continuous <- plot_signature_survival_continuous(biological_weights_paper, survival_data_paper, "paper", "SBS13")
