...
Run [Bootstrap_calculations.R](https://github.com/rishug123/SCLC-Commentary/blob/main/Bootstrap_calculations.R) with num_bs = 1000 in order to replicate the bootstrap optimal cutoffs. 
